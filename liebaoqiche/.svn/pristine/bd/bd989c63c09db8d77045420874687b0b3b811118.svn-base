	    	...
	    	<form id="DataForm" method="post">
	    		<table style="width: 100%;">
	    			<tbody>
	    				...
	    				<tr>
	    					<td style="width: 50%; padding: 5px; text-align: center;">
								<input class="easyui-combobox" id="integralCategoryId" name="integralCategoryId" value="${integral.integralCategoryId}" required="true" labelWidth="100" label="积分类型" style="width: 90%;"
								       data-options="
