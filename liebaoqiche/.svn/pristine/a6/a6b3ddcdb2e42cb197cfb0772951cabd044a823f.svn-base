	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			<table id="Grid" class="easyui-datagrid" title="" ctrlSelect="true" striped="true"
				...
				data-options="url:'${ctx}/activity/userActivity/list',fit:true, fitColumns:true, checkOnSelect:true, selectOnCheck:true, border: false">
			    <thead>
			        <tr>
			            ...
			            <th data-options="field:'userId',hidden:true,width:100">user_id</th>
			            <th data-options="field:'userName',width:100">用户名称</th>
			            <th data-options="field:'vinNo',width:160">车架号</th>
			            <th data-options="field:'activitySystemId',hidden:true,width:100">activity_system_id</th>
			            <th data-options="field:'activityName',width:120">活动名称</th>
			            <th data-options="field:'participationActivityTime',width:160">参与活动时间</th>
			...
			<div id="Grid_Toolbar">
				<form id="searchForm" name="searchForm">
					...
					<input class="easyui-textbox" id="activityName" name="activityName" data-options="prompt:'活动名称'" size="20">
					...
					<div class="pull-right">
						<!-- 测试发送mq消息 -->
					<%-- 	<shiro:hasPermission name="userActivity:create">
					        <a id="btnCreate" href="javascript:void(0)" class="easyui-linkbutton button-success"><i class="fa fa-send fa-lg"></i>&nbsp;&nbsp;发送mq</a>
						</shiro:hasPermission> --%>

						<shiro:hasPermission name="userActivity:update">
					        <a id="btnUpdate" href="javascript:void(0)" class="easyui-linkbutton button-default"><i class="fa fa-pencil fa-lg"></i>&nbsp;&nbsp;修改</a>
						</shiro:hasPermission>

						<shiro:hasPermission name="userActivity:delete">
	...
	<script type="text/javascript">
		require(['jquery','common'], function($){
			...
			$("#btnCreate").on('click', function(){
				...
				/* window.location.href = '${ctx}/activity/userActivity/add'; */
			}); 
			...
			$("#btnUpdate").on('click', function(){
				...
				if(selected.length == 1){
					window.location.href = '${ctx}/activity/userActivity/edit?id=' + selected[0].id;
				}
			});
				...
				if(selected.length == 0){
                    ...
                    $.messager.confirm('警告', '确认删除本条记录吗?', function (r) {
                        if(r){
                            ...
                            $.ajax({
	                            url: '${ctx}/activity/userActivity/delete',
	                            data: {
	                                ids: ids
	                            },
	                            type: 'post',
