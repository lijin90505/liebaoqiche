...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center'">
		...
		<table id="ActivityGrid" class="easyui-datagrid" title="已关联的活动" ctrlSelect="true" striped="true"
				rownumbers="true" pagination="false" toolbar="#Grid_Toolbar" style="height:300px;" fitColumns="true"
		...
		<table id="PayChannelGrid" class="easyui-datagrid" title="已关联的支付类型" ctrlSelect="true" striped="true" style="height:300px;"
				rownumbers="true" pagination="false" toolbar="#Grid_Toolbar" fitColumns="true"
				loadMsg="正在加载数据，请稍等..." emptyMsg="没有找到符合条件的数据"
				data-options="checkOnSelect:true, selectOnCheck:true, border: false">
			    <thead>
			        <tr>
