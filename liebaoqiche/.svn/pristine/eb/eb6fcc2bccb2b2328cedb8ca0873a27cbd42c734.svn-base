		...
		<form id="DataForm" method="post">
			<table style="width: 100%;">
				...
				<tr>
					...
					<td style="width: 50%; padding: 5px; text-align: center;">
						<input disabled="disabled" class="easyui-textbox" id="accessSystemId" name="accessSystemId" value="${systemActivity.accessSystemId}" labelWidth="100" label="系统标识" data-options="prompt:'系统标识'" style="width: 90%;">
					</td>
				</tr>
				<tr>
					<td style="width: 50%; padding: 5px; text-align: center;">
				...
				<tr>
					...
					<td style="width: 50%; padding: 5px; text-align: center;">
					<input class="" hidden="true" class="easyui-textbox" id="accessSystemName" name="accessSystemName" value="${systemActivity.accessSystemName}" labelWidth="100" label="系统名称" data-options="prompt:'系统名称'" style="width: 90%;">
					</td>
				</tr>
				<tr>
					<td style="width: 50%; padding: 5px; text-align: center;">
