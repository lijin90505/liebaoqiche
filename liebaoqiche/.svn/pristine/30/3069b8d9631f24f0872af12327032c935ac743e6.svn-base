...
public enum EnumCardGrantOrRecall {
	GRANT("发放", "0")/*, RECALL("撤回", "1")*/;

	private String value;
	private String label;

	private EnumCardGrantOrRecall(String label, String value) {
		this.label = label;
		this.value = value;
	}
	...
	public static String getLabel(String value) {
		...
		for (EnumCardGrantOrRecall c : EnumCardGrantOrRecall.values()) {
