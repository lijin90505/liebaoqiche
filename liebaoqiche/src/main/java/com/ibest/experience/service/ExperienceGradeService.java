...
public class ExperienceGradeService {
	 ...
	 * @throws Exception
	 */
	public int queryMaxNum() throws Exception{
		return experienceGradeDao.queryMaxNum();
	}
	
	/**
	* 查询列表
	*/
	public List<ExperienceGrade> findByObject(ExperienceGradeInputDTO inputDto) throws Exception{
		return experienceGradeDao.findByObject(inputDto);
	}
