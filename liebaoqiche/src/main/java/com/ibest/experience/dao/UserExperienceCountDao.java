...
public interface UserExperienceCountDao {
	 ...
	 * @return
	 */
	public Integer queryNumByUserId(String userId);
	
	public List<UserExperienceCount> countByList(UserExperienceCountInputDTO inputDTO);
	/**
	 * 批量删除
	 * @param ids
	 * @return
	...
	public List<UserExperienceCount> findByUserId(String userId);
