...
public class UserCarsService {
	...
	*/
	...
	public List<UserCars> findVinNoByUserId(String userId)throws Exception{
		return userCarsDao.findVinNoByUserId(userId);
	}
	
	public List<UserCars> findVinByUserId(String userId)throws Exception{
		return userCarsDao.findVinByUserId(userId);
	}
