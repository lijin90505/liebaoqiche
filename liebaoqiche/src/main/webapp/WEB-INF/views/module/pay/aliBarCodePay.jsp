	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			...
			<div class="weixin_page">
				<h3 class="weixin_page_title">支付宝手机扫码支付(支付金额后台固定)</h3>
				...
				<form action="${ctx}/pay/pay/sendAliBarCodePay">
				请输入付款码：<input type="text" name="authCode" >
				<input type="submit" class="pay-button" value="支付" />
				</form>
			</div>
		</div>
	</div>
