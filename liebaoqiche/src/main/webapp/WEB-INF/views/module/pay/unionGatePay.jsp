	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			...
			<div class="page_money">
				<span>0.1元</span>
				<span>商品描述：测试</span>
				<span>收款方：猎豹汽车XXXXXXXXXXXX(银联测试账号支付)</span>
			</div>
			<div class="weixin_page">
				<h3 class="weixin_page_title">银联扫码支付(支付金额后台固定)</h3>
				...
				<a href="${ctx}/pay/pay/sendUnionGatePay" target="view_window"><button id="unionGatePay"  class="pay-button">支付</button></a>
			</div>
		</div>
	</div>
...
// 				$("#unionGatePay").click(function(){
// 				    window.location.href="${ctx}/pay/pay/sendUnionGatePay";
// 			    })
		});
	</script>
</body>
