	    			...
	    			<tbody>
	    				<tr>
	    					<td style="width: 50%; padding: 5px; text-align: center;">
	    						<input class="easyui-textbox" maxlength="100" required="true" id="categoryName" name="categoryName" value="${integralCategory.categoryName}" labelWidth="100" label="类型名称"
							           data-options="prompt:'类型名称',
				    						validType:['length[1,14]','special','checkCategoryName']" style="width: 90%;">
	    					</td>
	    					<%-- <td style="width: 50%; padding: 5px; text-align: center;">
					    ...
					    <tr>
							...
							<textarea class="easyui-textbox" name="remarks" maxlength="1200"
							          ...
							          data-options="validType:'length[1,200]',multiline:true,prompt:'备注',tipPosition:'bottom'">${integralCategory.remarks}</textarea>
						    </td>
					    </tr>
	    				<tr>
	    					<td style="width: 50%; padding: 5px; text-align: center;">
