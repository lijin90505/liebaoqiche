	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			<table id="Grid" class="easyui-datagrid" title="" ctrlSelect="true" striped="true"
				...
				data-options="url:'${ctx}/integral/userIntegralCount/list',fit:true, fitColumns:true, checkOnSelect:true, selectOnCheck:true, border: false,onDblClickRow:onDblClickRow">
			    <thead>
			        <tr>
			            ...
			            <th data-options="field:'number',width:100">积分</th>
			            <!-- <th data-options="field:'categoryName',width:100">类型</th> -->
	...
	<script type="text/javascript">
		require(['jquery','common'], function($){
			...
			$("#btnCreate").on('click', function(){
				window.location.href = '${ctx}/integral/userIntegralCount/add';
			});
			...
			$("#btnUpdate").on('click', function(){
				...
				if(selected.length == 1){
					window.location.href = '${ctx}/integral/userIntegralCount/edit?id=' + selected[0].id;
				}
			});
				...
				if(selected.length == 0){
                    ...
                    $.messager.confirm('警告', '确认删除本条记录吗?', function (r) {
                        if(r){
                            ...
                            $.ajax({
	                            url: '${ctx}/integral/userIntegralCount/delete',
	                            data: {
	                                ids: ids
	                            },
	                            type: 'post',
		...
		function onDblClickRow (index, row) {
			/* showDialog('<i class="fa fa-eye fa-lg"></i>&nbsp;&nbsp;详情页面', '/admin/integral/userIntegralCount/view?id=' + row.id, 800, 500); */
		}
	</script>
</body>
</html>