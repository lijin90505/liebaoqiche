	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			<table id="Grid" class="easyui-datagrid" title="" ctrlSelect="true" striped="true"
				...
				data-options="url:'${ctx}/card/cardGet/list',fit:true, fitColumns:true, checkOnSelect:true, selectOnCheck:true, border: false,onDblClickRow:onDblClickRow">
			    <thead>
			        <tr>
			            <th data-options="field:'ck',checkbox:true"></th>
			            <th data-options="field:'id',hidden:true">id</th>
			            <th data-options="field:'name',width:100">卡券领取形式</th>
			...
			<div id="Grid_Toolbar">
				...
				<form id="searchForm" name="searchForm">
					<input class="easyui-textbox" id="name" name="name" labelWidth="70" data-options="validType:'special',validType:'special',prompt:'卡券获取形式'" style="width: 120px;"iconWidth="0">
	...
	<script type="text/javascript">
		require(['jquery','common'], function($){
			...
			$("#btnCreate").on('click', function(){
				showDialog('新增', '${ctx}/card/cardGet/add', 800, 500, function () {
			...
			$("#btnUpdate").on('click', function(){
				...
				if(selected.length == 1){
					showDialog('编辑', '${ctx}/card/cardGet/edit?id=' + selected[0].id, 800, 500, function () {
						$('#Grid').datagrid('reload');
					});
				}
			});
		...
		function onDblClickRow (index, row) {
			showDialog('<i class="fa fa-eye fa-lg"></i>&nbsp;&nbsp;详情页面', '/admin/card/cardGet/view?id=' + row.id, 800, 500);
		}
	</script>
</body>
</html>