	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			<table id="Grid" class="easyui-datagrid" title="" ctrlSelect="true" striped="true"
				...
				data-options="url:'${ctx}/card/couponGet/list',fit:true, fitColumns:true, checkOnSelect:true, selectOnCheck:true, border: false">
			    <thead>
			        <tr>
			            <th data-options="field:'ck',checkbox:true"></th>
			            <th data-options="field:'id',hidden:true">id</th>
			            <th data-options="field:'isDelete',hidden:true">是否删除；0未删除，1删除</th>
			            <th data-options="field:'getType'">卡券获取</th>
			...
			<div id="Grid_Toolbar">
				<form id="searchForm">
					<shiro:hasPermission name="couponGet:query">
						<input class="easyui-textbox" name="getType" data-options="prompt:'卡券领取形式'" size="25">
	...
	<script type="text/javascript">
		require(['jquery','common'], function($){
			...
			$("#btnCreate").on('click', function(){
				showDialog('新增', '${ctx}/card/couponGet/add', 800, 500, function () {
			...
			$("#btnUpdate").on('click', function(){
				...
				if(selected.length == 1){
					showDialog('编辑', '${ctx}/card/couponGet/edit?id=' + selected[0].id, 800, 500, function () {
						$('#Grid').datagrid('reload');
					});
				}
			});
