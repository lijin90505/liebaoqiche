	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center'">
			<table id="Grid" class="easyui-datagrid" title="" ctrlSelect="true" striped="true"
				...
				data-options="url:'${ctx}/activity/activityIntegral/list',fit:true, fitColumns:true, checkOnSelect:true, selectOnCheck:true, border: false">
			    <thead>
			        <tr>
			            <th data-options="field:'ck',checkbox:true"></th>
			            <th data-options="field:'id'">id</th>
			            <th data-options="field:'integralId'">integral_id</th>
	...
	<script type="text/javascript">
		require(['jquery','common'], function($){
			...
			$("#btnCreate").on('click', function(){
				window.location.href = '${ctx}/activity/activityIntegral/add';
			});
			...
			$("#btnUpdate").on('click', function(){
				...
				if(selected.length == 1){
					window.location.href = '${ctx}/activity/activityIntegral/edit?id=' + selected[0].id;
				}
			});
				...
				if(selected.length == 0){
                    ...
                    $.messager.confirm('警告', '确认删除本条记录吗?', function (r) {
                        if(r){
                            ...
                            $.ajax({
	                            url: '${ctx}/activity/activityIntegral/delete',
	                            data: {
	                                ids: ids
	                            },
	                            type: 'post',
